...
class _HomeScreenState extends State<HomeScreen> {
  ...
  {'name': 'All', 'icon': Icons.grid_view_rounded, 'color': const Color(0xFF00B4D8)},
  {'name': 'Traditional', 'icon': Icons.account_balance_rounded, 'color': const Color(0xFFFFB347)},
  {'name': 'Emerging Tech', 'icon': Icons.computer_rounded, 'color': const Color(0xFF00B4D8)},
  {'name': 'Science', 'icon': Icons.science_rounded, 'color': const Color(0xFF4CAF50)},
  {'name': 'Creative', 'icon': Icons.brush_rounded, 'color': const Color(0xFFB388FF)},
  {'name': 'Underrated but Growing', 'icon': Icons.trending_up_rounded, 'color': const Color(0xFFFF6B6B)},
];
  ...
  decoration: BoxDecoration(
    color: _getCategoryColor(career.category).withOpacity(0.15),
